                ...
                <p class="card-text">You can buy our <?php echo e($settings->token_symbol); ?> token using the below currency choices to become part of our project.</p>
                 <div class="row">
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('USD')">
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('EUR')">
                            <div class="card bg-<?php echo e($bg); ?> shadow-none">
                                <div class="card-body">
                    ...
                    <div class="mb-1 col-md-6" wire:click="setpaymethod('GBP')" style="cursor: pointer;">
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('BTC')">
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('LTC')">
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('ETH')">
                            <div class="shadow-none card bg-<?php echo e($bg); ?>">
                                <div class="card-body">
                                <span>
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('USDT')">
                            <div class="shadow-none card bg-<?php echo e($bg); ?>">
                                <div class="card-body">
                                <span> USDT</span> 
                    ...
                    <div class="mb-1 col-md-6">
                        <a style="cursor: pointer;" class="text-decoration-none" wire:click="setpaymethod('BNB')">
                            <div class="shadow-none card bg-<?php echo e($bg); ?>">
                                <div class="card-body">
                                <span> BNB</span> 
...
</div><?php /**PATH /home/bryngrgz/lulocash.brynamics.xyz/resources/views/livewire/buy-token.blade.php ENDPATH**/ ?>