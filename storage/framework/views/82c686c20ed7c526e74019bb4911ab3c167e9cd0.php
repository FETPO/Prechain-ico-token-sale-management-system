...
<?php if (! $__env->hasRenderedOnce('ea7a0211-dba2-44c1-95d2-6ce082bf5994')): $__env->markAsRenderedOnce('ea7a0211-dba2-44c1-95d2-6ce082bf5994'); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingPassword']); ?>
     ...
     <?php $__env->slot('content'); ?> 
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['type' => 'password','class' => 'block w-3/4','placeholder' => ''.e(__('Password')).'','xRef' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'password','class' => 'block w-3/4','placeholder' => ''.e(__('Password')).'','x-ref' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\VICTORY.E\Documents\Brynamics\Prechain (1)\resources\views/vendor/jetstream/components/confirms-password.blade.php ENDPATH**/ ?>