           ...
           <div class="mt-2 mb-5">
                ...
                <div class="d-inline">
                    <div class="float-right btn-group">
                        <a class="btn btn-primary btn-sm" href="<?php echo e(route('viewtransaction', $tran->id)); ?>"> <i class="fa fa-arrow-left"></i> back</a>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('storage/'. $tran->proof)); ?>" class="img-fluid w-75" alt="screenshot">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VICTORY.E\Documents\Brynamics\Prechain (1)\resources\views/admin/trans-image.blade.php ENDPATH**/ ?>