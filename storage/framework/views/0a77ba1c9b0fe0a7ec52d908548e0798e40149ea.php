                ...
                <form method="POST" action="<?php echo e(route('wallet.update')); ?>">
                  ...
                  <?php echo method_field('put'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="network" value="<?php echo e(Auth::user()->network); ?>">
                    </div>
                    <div class="mb-3">
...
} elseif ($_instance->childHasBeenRendered('1gg0P1W')) {
    $componentId = $_instance->getRenderedChildComponentId('1gg0P1W');
    $componentTag = $_instance->getRenderedChildComponentTagName('1gg0P1W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1gg0P1W');
} else {
    $response = \Livewire\Livewire::mount('transfer-token', []);
    $html = $response->html();
    $_instance->logRenderedChild('1gg0P1W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<!-- /deposit Modal --><?php /**PATH C:\Users\VICTORY.E\Documents\Brynamics\Prechain (1)\resources\views/user/modal.blade.php ENDPATH**/ ?>