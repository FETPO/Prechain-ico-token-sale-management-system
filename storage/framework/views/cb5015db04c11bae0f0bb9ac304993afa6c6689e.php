...
<head>
    ...
    <title>Prechain - Bitcoin and Cryptocurrency ICO System</title>
    <meta name="description" content="Prechain is a Bitcoin and Cryptocurrency ICO System." />
    <meta name="keywords" content="bitcoin, ethereum, monero, ico, token, free token, btc, eth" />


    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('front/assets/images/favicon.png')); ?>" />
            ...
            <div class="row">
                <div class="col-12 position-relative">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="/" class="logo">
                            <img src="<?php echo e(asset('front/assets/images/logos/light.png')); ?>" class="light-logo"
                                alt="Prechain ICO" />
                            <img src="<?php echo e(asset('front/assets/images/logos/dark.png')); ?>" class="dark-logo"
                                alt="Prechain ICO" />
                        </a>
                        <!-- ***** Logo End ***** -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 align-self-center">
                        <h1>Prechain Decentralized Blockchain ICO System</h1>
                        <p>Prechain makes it easy for user or Businesses who wants to Create there own Coins, Prechain
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 align-self-center">
                        <div class="box">
                            <div class="token">
                                <h6 class="title"><span class="text-primary">PRECHAIN</span> ICO SALE IS OPEN
                                </h6>
                                <!-- ***** Countdown Start ***** -->
                                <ul class="countdown">
                                    <li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 align-self-center">
                    ...
                    <div class="left-text">
                        <p class="dark">Prechain (PRECHAIN) is an open source, Bitcoin-like digital currency
                            which uses
                            a
                            proof of work script algorithm.</p>
                        <p>The genesis block was mined on March 1st, 2014. The total number of mineable PRECHAIN is
                            245,465,283. The mining of Prechain is divided into Epochs: each Epoch mines 36000 blocks of
                            ...
                            <div class="col-lg-6 col-md-6 cols-m-12">
                                ...
                                <div class="token-info">
                                    ...
                                    <div class="item">
                                        ...
                                        <span>100.000.000 PRECHAIN ETH</span>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        ...
                                        <span>ETH, ETC - PRECHAIN 20</span>
                                    </div>
                                    <div class="item">
                                        <strong>Circulation Supply</strong>
                                        <span>37.000.000 PRECHAIN ETH</span>
                                    </div>
                                    <div class="item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <p>Development of a desktop application for Windows, Android Wallet. Connecting Sidechain +
                                Secure Sandbox. Opportunity to create decentralized applications on the PRECHAIN
                                platform.
                            </p>
                        </div>
                    </div>
            ...
            <div class="roadmap-item-full" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.3s">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <p>Placement of Prechain on exchanges. The list of exchanges that placed PRECHAIN will be
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 align-self-center mobile-bottom-fix">
                    ...
                    <div class="left-text light m-bottom-0">
                        ...
                        <ul>
                            <a href="">
                                <li> PRECHAIN Wallet</li>
                            </a>
                            <li>Transaction info</li>
                            <li>My account</li>
                            <li>Blockchain Explorer</li>
                            <li>Transfer</li>
                            <li>Connected peers to network PRECHAIN</li>
                        </ul>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-4">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="badge">4</span> Why should I use PRECHAIN currency and how is
                                    it
                                    different
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-5">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="badge">5</span> How is PRECHAIN helping entrepreneurs?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-7">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="badge">7</span> How do I convert my PRECHAIN currency into US
                                    dollars
                                    or
                                    other currencies?
                                </button>
                        ...
                        <div class="contact">
                            ...
                            <ul class="list">
                                <li><i class="fa fa-envelope-o"></i><a
                                        href="mailto:support@prechain.brynamics.xyz">support@prechain.brynamics.xyz</a>
                                </li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <p class="copyright">2022 © Prechain - Bitcoin and Cryptocurrency ICO System </p>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/bryngrgz/lulocash.brynamics.xyz/resources/views/home/index.blade.php ENDPATH**/ ?>