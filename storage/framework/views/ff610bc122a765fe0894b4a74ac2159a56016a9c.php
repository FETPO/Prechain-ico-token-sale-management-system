...
<div class="logo-header" data-background-color="blue">
                ...
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('adminprofile')); ?>">Account</a>
    ...
    <!-- End Navbar -->
</div><?php /**PATH C:\Users\VICTORY.E\Documents\Brynamics\Prechain (1)\resources\views/admin/topmenu.blade.php ENDPATH**/ ?>