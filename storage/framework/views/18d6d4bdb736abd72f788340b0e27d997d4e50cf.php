                                        ...
                                        <div class="p-3 col-12 col-stats">
                                            ...
                                            <h4 class="card-title text-<?php echo e($bg); ?>">
                                                <?php if(empty(Auth::user()->tot_tk_bal)): ?>
                                                    0
                                                <?php else: ?>
                                                  <?php echo e(number_format(Auth::user()->tot_tk_bal,2,".",",")); ?>   
                                                <?php endif; ?>
                       ...
                       <div class="bg-white col-md-8">
                            <div class="row">
                                <div class="p-3 col-md-3">
                                    <img src="<?php echo e(asset('storage/app/public/'. $settings->logo)); ?>" class="img-fluid w-125"> 
                                </div> 
                                <div class="p-3 col-md-9">
                                    <h3>Thank you for choosing <?php echo e($settings->site_name); ?></h3>
                                    <p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\VICTORY.E\Documents\Brynamics\Prechain (1)\resources\views/user/dashboard.blade.php ENDPATH**/ ?>