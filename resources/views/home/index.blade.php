            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 align-self-center">
                        <h1>{{$settings->site_name}} Decentralized Blockchain ICO System</h1>
                        <p>{{$settings->site_name}} makes it easy for user or Businesses who wants to Create there own Coins, {{$settings->site_name}}
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 align-self-center">
                        <div class="box">
                            <div class="token">
                                <h6 class="title"><span class="text-primary">{{$settings->site_name}}</span> ICO SALE IS OPEN
                                </h6>
                                <!-- ***** Countdown Start ***** -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <p>Development of a desktop application for Windows, Android Wallet. Connecting Sidechain +
                                Secure Sandbox. Opportunity to create decentralized applications on the {{$settings->site_name}}
                                platform.
                            </p>
                        </div>
                    </div>
            ...
            <div class="roadmap-item-full" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.3s">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <p>Placement of {{$settings->site_name}} on exchanges. The list of exchanges that placed {{$settings->site_name}} will be
